...
sample_het <- read.table("PPMI_july2018.snpqc.PD_cases.snpqc2.sampleqc.het", header = TRUE)

#Read in sample call rate table
sample_callrate <- read.table("PPMI_july2018.snpqc.PD_cases.snpqc2.sampleqc.imiss", header = TRUE)
